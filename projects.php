...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item"><a href="projects.php" class="navele active">Projects</a></li>
  ...
  <div id="main">
    ...
    for ($i = 1; $i <= $filecount / 3; $i++) {
      $path = "projects/" . $i . "l.txt";
      $myfile = fopen($path, "r");
      $link = fread($myfile, filesize("projects/{$i}l.txt"));
      fclose($myfile);

      $path = "projects/" . $i . ".txt";
      $myfile = fopen($path, "r");
      $desc = fread($myfile, filesize("projects/{$i}.txt"));
      fclose($myfile);
